const skills = [
  ...
  { compétence: 'HTML/CSS', autoévaluation: 'expert' },
  ...
  { compétence: 'BasketBall', autoévaluation: 'intermédiaire' },
  { compétence: 'Tennis', autoévaluation: 'intermédiaire' },
  { compétence: 'BreakDance', autoévaluation: 'avancé' },
  { compétence: 'Escalade', autoévaluation: 'débutant' },
  { compétence: 'Peinture', autoévaluation: 'intermédiaire' },
  { compétence: 'Anglais', autoévaluation: 'intermédiaire' },
  { compétence: 'MongoDB', autoévaluation: 'débutant' }
];

skills.sort((a, b) => a.compétence.localeCompare(b.compétence)); // Tri par ordre alphabétique
